...
<style>
    ...
    <hr/>
    {{ Form::model($user, array('enctype' => 'multipart/form-data', 'method'=> 'PATCH', 'url' => array('perfil', $user->id), 'class' => 'form-horizontal '))}}
    ...
    <div class="col-sm-3">
        <img src="{{  url('assets/img/profile', $user->photo) }}" class="center-block img-responsive img-circle profile-avatar"
             alt="Imagem do perfil">
        <input class="btn-primary btn" name="avatar" type="file"/>
    </div>
    <div class="col-sm-12">
